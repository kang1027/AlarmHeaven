...
<head>
<meta http-equiv="Content-Type" content="audio/mp3; charset=UTF-8">
...
<%
    ...
    String downMusicName = request.getParameter("downMusicName");
     
    // 업로드한 폴더의 위치와 업로드 폴더의 이름을 알아야 한다.
    String savePath ="/uploadMusic\\"+session.getAttribute("id")+"music";// WebContent/uploadFile
    ...
    String sFilePath = sDownPath +"\\" + downMusicName;// ex)c:\\uploadPath\\image.jpg
    ...
    String sEncoding =new String(downMusicName.getBytes("utf-8"),"8859_1");
    //String B = "utf-8";
